...
Public Class clsSavingSchme
    ...
    Private Sub LoadForm()
        oForm = oApplication.Utilities.LoadForm(xml_SavingSchme, frm_SavingScheme)
...
#End Region
    ...
    Private Sub Databind(ByVal aform As SAPbouiCOM.Form)
        ...
        FillCombobox(oCombobox, "Select Code,Remarks from OUDP")
    ...
    Private Function Validation(ByVal aForm As SAPbouiCOM.Form) As Boolean
        Try
            ...
            Catch ex As Exception
                strPostMethod = "ALL"
            End Try
            If strPostMethod = "ALL" Or strPostMethod = "" Then
                strDEPT = " 1=1"
            Else
                strDEPT = "T1.dept=" & strPostMethod
            End If
            ...
            strquery = strquery & " Inner Join OHEM T1 on T1.empID=T0.[U_Z_empid]  where (" & strCondition & ") and " & strDEPT & " and  U_Z_Posted='Y' and  T0.U_Z_CompNo='" & strCompany & "'  and U_Z_YEAR=" & intYear & " and U_Z_MONTH=" & intMonth & ""
            Dim otest As SAPbobsCOM.Recordset
            otest = oApplication.Company.GetBusinessObject(SAPbobsCOM.BoObjectTypes.BoRecordset)
            otest.DoQuery(strquery)
            If otest.RecordCount <= 0 Then
                oApplication.Utilities.Message("Payroll worksheet Details not available", SAPbouiCOM.BoStatusBarMessageType.smt_Error)
                Return False
            Else
    ...
    Private Sub GridBind(ByVal aForm As SAPbouiCOM.Form)
        ...
        Try
            ...
            strquery = strquery & " inner Join OHEM T1 on T1.empID=T0.U_Z_empid  Left Join OUDP T2 on T2.Code =T1.dept where  (" & strCondition & ") and (" & strDEPT & ") and T0.U_Z_CompNo='" & strCompany & "' and    U_Z_YEAR=" & intYear & " and U_Z_MONTH=" & intMonth & ""
    ...
    Private Sub PrintPaySlip(ByVal aform As SAPbouiCOM.Form, aReportChoice As String)
        ...
        Try
            ...
            ElseIf aReportChoice = "SavingScheme" Then
                    ...
                    If oGrid.DataTable.GetValue("Email", intRow) <> "" Then
                        ...
                        If File.Exists(strReportFileName) Then
                            ...
                            If strRefCode <> 0 Then
                                ...
                                Else
                                    oCrystalDocument.SetParameterValue("Month", CInt(strmonth))
                                    oCrystalDocument.SetParameterValue("Year", CInt(strYear))
                                    oCrystalDocument.SetParameterValue("U_Z_Empid", strEmpId)
                                    '  oCrystalDocument.SetParameterValue("StaffID", CInt(strEmpId))
                                End If
                            ...
                            Dim strMessage As String = "Saving Scheme for " & MonthName(CInt(strmonth)) & "_" & strYear
...
#Region "Item Event"
    Public Overrides Sub ItemEvent(ByVal FormUID As String, ByRef pVal As SAPbouiCOM.ItemEvent, ByRef BubbleEvent As Boolean)
        Try
            If pVal.FormTypeEx = frm_SavingScheme Then
                            ...
                            Case SAPbouiCOM.BoEventTypes.et_ITEM_PRESSED
                                ...
                                ElseIf pVal.ItemUID = "13" Then
                                    If oApplication.SBO_Application.MessageBox("Do you want to send the Payslips in Email?", , "Yes", "No") = 2 Then
                                        Exit Sub
                                    End If
                                    PrintPaySlip(oForm, "SavingScheme")
                                End If
