...
#Region "Public Functions"
    ...
    Public Sub CreateTables()
        ...
        Try
            ...
            AddTables("Z_PAY_OMAIL", "Email SetUp Details", SAPbobsCOM.BoUTBTableType.bott_NoObject)
            AddFields("Z_PAY_OMAIL", "Z_SMTPSERV", "SMTP SERVER", SAPbobsCOM.BoFieldTypes.db_Alpha, , 100)
            AddFields("Z_PAY_OMAIL", "Z_SMTPPORT", "SMTP PORT", SAPbobsCOM.BoFieldTypes.db_Alpha, , 10)
            AddFields("Z_PAY_OMAIL", "Z_SMTPUSER", "SMTP USER", SAPbobsCOM.BoFieldTypes.db_Alpha, , 100)
